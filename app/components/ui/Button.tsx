...
export default function Button({
  ...
  const baseStyles = 'font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center shadow-md hover:shadow-lg'
  ...
  const variants = {
    ...
    outline: 'border-2 border-gray-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:border-blue-400 text-gray-700 hover:text-blue-700 focus:ring-blue-500'
  }
